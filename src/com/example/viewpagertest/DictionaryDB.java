...
public class DictionaryDB extends SQLiteOpenHelper {
	...
	private final static String DB_PATH = "/data/data/com.example.viewpagertest/databases/";
	private final Context context;
	public final static int DB_VERSION = 2;
	public final static String DB_NAME = "dictionary.sqlite";
	public final static String DB_BASE_DIC_COVER_NAME = "word_simple.mp3";
	public final static String DB_BASE_DIC = "word_simple.sqlite";
	...
	public View queryWord(Context context, String word, String xmlfile)
		...
		SQLiteDatabase sqLiteDatabase = SQLiteDatabase.openDatabase(
				Environment.getExternalStorageDirectory() + "/"
						+ Constants.SAVE_DIRECTORY + "/.collins.lib", null,
				SQLiteDatabase.OPEN_READONLY);
		String table = "collinsdic";
